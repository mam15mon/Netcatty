...
const en: Messages = {
  ...
  'settings.terminal.behavior.preserveSelectionOnInput.desc':
    'Don\'t clear mouse-selected text when typing.',
  ...
  'settings.terminal.keywordHighlight.invalidPatternSyntax': 'Regex syntax invalid',
  'settings.terminal.keywordHighlight.patternRejectedBySafety': 'Rejected by safety policy: {reason}',
  'settings.terminal.keywordHighlight.copyColor': 'Copy color',
  ...
  'sftp.nav.up': 'Go to Parent Directory',
  ...
  'sftp.retry': 'Retry',
  'sftp.context.open': 'Open File / Enter Directory',
  'sftp.context.navigateTo': 'Navigate to Selected Directory',
  'sftp.context.moveTo': 'Move to...',
  'sftp.context.moveToParent': 'Go to Parent Directory',
  ...
  'sftp.kind.file': 'File',
  'sftp.kind.link': 'Link',
  'sftp.kind.linkToFolder': 'Link → Folder',
  'sftp.sr.symlink': ' (symbolic link)',
  ...
  'sftp.goUp': 'Go up',
  'sftp.logs.show': 'Show logs',
  'sftp.logs.hide': 'Hide logs',
  ...
  'terminal.toolbar.sessionLog': 'Session log',
  'terminal.toolbar.sessionLogStart': 'Start session logging',
  'terminal.toolbar.sessionLogStop': 'Stop session logging',
  'terminal.toolbar.sessionLogStarted': 'Session logging started',
  'terminal.toolbar.sessionLogStopped': 'Session logging stopped',
  'terminal.toolbar.sessionLogAutoEnabled': 'Auto session logging is enabled. Disable it in Settings before using manual logging.',
  'terminal.toolbar.sessionLogDisabledByAuto': 'Manual logging is disabled while auto session logging is enabled',
  'terminal.toolbar.sessionLogFailed': 'Session log operation failed',
  ...
  'terminal.composeBar.sendTarget': 'Send target',
  'terminal.composeBar.sendTarget.currentTab': 'Current tab',
  'terminal.composeBar.sendTarget.currentSplit': 'Current split',
  'terminal.composeBar.sendTarget.allSessions': 'All sessions',
  ...
  'terminal.toolbar.hostHighlight.invalidPatternSyntax': 'Regex syntax invalid',
  'terminal.toolbar.hostHighlight.patternRejectedBySafety': 'Rejected by safety policy: {reason}',
  ...
  'regexSafety.reason.nested_quantifier': 'group with inner quantifier is quantified again',
  'regexSafety.reason.unknown': 'unknown safety rule violation',
  ...
  'snippets.menu.newButton': 'New Button...',
