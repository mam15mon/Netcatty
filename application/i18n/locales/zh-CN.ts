...
const zhCN: Messages = {
  ...
  'sftp.retry': '重试',
  'sftp.context.open': '打开文件 / 进入目录',
  'sftp.context.navigateTo': '跳转到选中目录',
  'sftp.context.moveTo': '移动到...',
  'sftp.context.moveToParent': '返回上级目录',
  ...
  'sftp.kind.file': '文件',
  'sftp.kind.link': '链接',
  'sftp.kind.linkToFolder': '链接 → 文件夹',
  'sftp.sr.symlink': '（符号链接）',
  ...
  'terminal.toolbar.sessionLog': '会话日志',
  'terminal.toolbar.sessionLogStart': '开始记录日志',
  'terminal.toolbar.sessionLogStop': '结束记录日志',
  'terminal.toolbar.sessionLogStarted': '已开始记录会话日志',
  'terminal.toolbar.sessionLogStopped': '已结束会话日志记录',
  'terminal.toolbar.sessionLogAutoEnabled': '已启用自动会话日志，请先在设置中关闭后再使用手动记录',
  'terminal.toolbar.sessionLogDisabledByAuto': '自动会话日志已启用（手动记录已禁用）',
  'terminal.toolbar.sessionLogFailed': '会话日志操作失败',
  ...
  'terminal.composeBar.sendTarget': '发送至',
  'terminal.composeBar.sendTarget.currentTab': '当前标签页',
  'terminal.composeBar.sendTarget.currentSplit': '当前会话',
  'terminal.composeBar.sendTarget.allSessions': '全部会话',
  ...
  'terminal.toolbar.hostHighlight.invalidPatternSyntax': '语法无效',
  'terminal.toolbar.hostHighlight.patternRejectedBySafety': '安全策略拒绝：{reason}',
  ...
  'regexSafety.reason.nested_quantifier': '存在嵌套量词，可能导致灾难性回溯',
  'regexSafety.reason.unknown': '未知原因',
  ...
  'terminal.progress.queued': '正在排队等待连接槽位',
  ...
  'settings.terminal.behavior.smoothScrolling.inertiaCurve.responsive': '灵敏',
  'settings.terminal.behavior.smoothScrolling.inertiaCurve.gentle': '柔和',
  ...
  'settings.terminal.keywordHighlight.invalidPatternSyntax': '语法无效',
  'settings.terminal.keywordHighlight.patternRejectedBySafety': '安全策略拒绝：{reason}',
  'settings.terminal.keywordHighlight.copyColor': '复制颜色',
